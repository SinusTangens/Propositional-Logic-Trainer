...
export default function UnitPropagation() {
  ...
  const levelParam = searchParams.get('level'); // '1', '2', '3', '4' oder 'random'
  ...
  const loadTask = async (level: number) => {
    ...
    const response = await generateTask({ task_type: 'DIRECT_INFERENCE', level });
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-6 mb-8">
          <div className="flex items-center justify-center w-24 h-24 rounded-full text-white bg-blue-600">
